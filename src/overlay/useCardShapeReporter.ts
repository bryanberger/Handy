...
interface CardShapeReporterOptions {
   ...
   * resolved overlay theme — it pulls one on every show and listens for
 ...
 * streamed text and phase — the backend cannot see it any other way. The
 ...
 *
 * Under Flat, and off macOS where the effective Material is never Glass, not
 * a single extra message is sent.
 */
